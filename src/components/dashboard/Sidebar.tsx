        ...
        <div className="p-4 border-t border-gray-800">
          <div className="flex items-center space-x-3">
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="flex items-center space-x-3 flex-1 min-w-0 hover:bg-gray-800 rounded-xl p-2 transition-colors"
            >
              <div className="w-10 h-10 rounded-xl overflow-hidden bg-blue-500 flex-shrink-0">
                {user?.avatar ? (
              ...
              <div className="flex-1 min-w-0 text-left">
                ...
                <div className="text-xs text-gray-400">{user?.role || 'Supply Chain Admin'}</div>
              </div>
            </motion.button>
